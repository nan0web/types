...
export default class ContainerObject {
	 ...
	 */
	map(
		callback: (value: ContainerObject, index: number, arr: ContainerObject[]) => any[],
		recursively?: boolean | undefined,
	): any[]
	/**
	 ...
	 */
	asyncMap(
		callback: (value: ContainerObject, index: number, arr: ContainerObject[]) => Promise<any[]>,
		recursively?: boolean | undefined,
	): Promise<any[]>
}
